...
class Graph
{
    ...
    void bfs(int s)
    {
    	...
    	while(!Queue.isEmpty())
    	{
    		...
    		while(iter.hasNext())
    		{
    			...
    			if(!visited[temp.dest])
    			{
    				...
    				dist[temp.dest]=dist[n]+1;
    				//System.out.print(temp.dest+" ");
    				//not this while adding but removing
    			}
    		}
    	...
    	//from s to all distances are
    	System.out.println("distances to all nodes from "+s);
    	for(int i=0;i<V;i++)
    	{
...
public class bfs_imple 
{
  public static void main(String[]args)
  {
      ...
      //find shortes dist to all nodes from s
      int s=1;
      g.bfs(s);
